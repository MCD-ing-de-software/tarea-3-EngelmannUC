...
class TestStatisticsUtils(unittest.TestCase):
    ...
    def test_zscore_has_mean_zero_and_unit_std(self):
        ...
        expected_mean = 0
        expected_std = 1
        self.assertAlmostEqual(mean, expected_mean, delta=0.00000000001)
        self.assertAlmostEqual(std, expected_std, delta=0.00000000001)
    ...
    def test_min_max_scale_maps_to_zero_one_range(self):
        ...
        expected_min = 0
        expected_max = 1
        self.assertAlmostEqual(min_val, expected_min)
        self.assertAlmostEqual(max_val, expected_max)
        npt.assert_allclose(result, expected, rtol=1e-7, atol=1e-7)
